...
public class Application implements ActionListener{
    ...
    private static double nationalMean = 20.2; //mean national UK househould emission in tonnes 
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        resultLabel.setText("");
            if(!userText.getText().equals("")){
                ...
                double pos_or_neg = nationalMean - (calc.total());
                if(pos_or_neg < 0){
                    double temp_value = Math.abs(pos_or_neg);
                    double percent = (temp_value/nationalMean)*100;
                    percent = (int) (percent*100);
                    JOptionPane.showMessageDialog(frame, "<html>Carbon Dioxide: " + calc.nCarbonOxide/100 + "g" +
                            "<br/>Methane: " + calc.nMethane/100 + "g" +
                            "<br/>Nitrous Oxide: " + calc.nNitrogen/100 + "g" +
                            "<br/>Total Emission: " + calc.total() + " tonnes<br/>" 
                            + percent/100 + "% more than the national mean</html>");
                }
                else{
                    ...
                    JOptionPane.showMessageDialog(frame, "<html>Carbon Dioxide: " + calc.nCarbonOxide/100 + "g" +
                            ...
                            "<br/>Nitrous Oxide: " + calc.nNitrogen/100 + "g" +
                            "<br/>Total Emission: " + calc.total() + " tonnes<br/>" 
                            + percent/100 + "% less than the national mean</html>");
                }
